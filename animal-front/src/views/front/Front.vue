<template>
  <div style="background: #F0F8FF">
    ...
    <div style="position: relative; z-index: 100; display: flex; background-color: #fff; height: 60px; line-height: 60px; border-bottom: 1px solid #eee">
      ...
      <div style="flex: 1">
        ...
        <el-menu :default-active="'1'" class="el-menu-demo" mode="horizontal" router style="border-bottom: none">
