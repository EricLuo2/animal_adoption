      ...
      <div style="width: 100%; display: flex">
        <div style="width:100%">
          <el-carousel height="400px">
            <el-carousel-item>
              <img src="@/assets/b1.jpg" alt="" style="width: 100%;height: 100%">
            </el-carousel-item>
            <el-carousel-item>
              <img src="@/assets/b2.jpg" alt="" style="width: 100%;height: 100%">
            </el-carousel-item>
            <el-carousel-item>
              <img src="@/assets/b3.jpg" alt="" style="width: 100%;height: 100%">
            </el-carousel-item>
          </el-carousel>
        </div>
      </div>
